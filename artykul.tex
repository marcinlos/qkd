...
W tej sekcji przyjrzymy się pewnym klasycznym algorytmom dystrybucji (tworzenia) klucza, opartym
...
trudniejszy niż DLP. Redukcja w drugą stronę nie jest znana\footnotemark. 
...
Warto zaznaczyć, że jakkolwiek wielomianowy algorytm dla problemu logarytmu dyskretnego nie jest 
znany\footnote{Przegląd ich znaleźć można np. w \cite{Sutherland07}}, to istnieje efektywny algorytm
kwantowy \cite{Shor97}, zatem ewentualny rozwój komputerów kwantowych wymusi tak czy inaczej zarzucenie
użycia protokołu Diffiego-Hellmana\footnotemark.
