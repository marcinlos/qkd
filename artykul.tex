...
ilości informacji, które zostały przechwycone. Np. omówiony w dalszej części protokół Ekerta wykrywa
podsłuch poprzez testowanie nierówności Bella -- jeśli jest zachowana, stan systemu uległ zmianie w 
wyniku działań zewnętrznych.
...
Istnieją dwie główne rodziny metod privacy amplification.
...
otrzymujemy podobnie jak w przypadku kodów liniowych krótszy klucz o dużej entropii.


\section{Przykładowe algorytmy QKD}
